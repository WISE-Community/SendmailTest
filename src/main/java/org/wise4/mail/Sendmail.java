 ...
 * and other websites.
 * 
 * Config settings (ie username,password,toEmailAddress,etc) must stored in src/main/resources/mail.properties.
 * 
 * Usage
 * Option 1
 * 1. Copy src/main/resources/sample_mail.properties to src/main/resources/mail.properties and edit the file.
 * 2. Run mvn compile
 * 3. Run mvn test.  This will in effect run the JUnit tests in src/main/test/SendmailTest.java
 * 
 * Option 2
 * 1. Copy src/main/resources/sample_mail.properties to src/main/resources/mail.properties and edit the file.
 * 2. Import this project in Eclipse (in Eclipse, "File"->"Import..."->"Existing Projects into Workspace"
 * 3. Run Sendmail.java as Java Application. (Right click on Sendmail.java->"Run As"->"Java Application"
 * 
